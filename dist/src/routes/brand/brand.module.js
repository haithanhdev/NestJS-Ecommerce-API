...
const brand_translation_module_1 = require("./brand-translation/brand-translation.module");
...
exports.BrandModule = BrandModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [brand_service_1.BrandService, brand_repo_1.BrandRepo],
        imports: [brand_translation_module_1.BrandTranslationModule],
    })
], BrandModule);
