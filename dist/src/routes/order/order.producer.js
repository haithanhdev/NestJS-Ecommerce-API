...
let OrderProducer = class OrderProducer {
    ...
    async addCancelPaymentJob(paymentId) {
        return this.paymentQueue.add(queue_constant_1.CANCEL_PAYMENT_JOB_NAME, { paymentId }, {
            delay: 1000 * 60 * 60 * 24,
            jobId: (0, helpers_1.generateCancelPaymentJobId)(paymentId),
