...
import { CreateProductBodyType, GetManageProductsQueryType, UpdateProductBodyType } from 'src/routes/product/product.model';
export declare class ManageProductService {
    ...
    update({ productId, data, updatedById, roleNameRequest, }: {
        productId: number;
    ...
    delete({ productId, deletedById, roleNameRequest, }: {
        productId: number;
        deletedById: number;
        roleNameRequest: string;
    }): Promise<{
